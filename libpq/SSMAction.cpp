...
int SSMAction::SSMSaveWhitebalanceGammaMode(int offset, int rw_val) {
    return SSMWriteNTypes(VPP_DATA_POS_WB_GAMMA_MODE_START, 1, &rw_val, offset);
}

int SSMAction::SSMReadWhitebalanceGammaMode(int offset, int *rw_val) {
