...
enum{
    ...
    VPP_DATA_POS_COLOR_TEMP_PARAM_START = 311,
    VPP_DATA_POS_COLORCUSTOMIZE_CM_START = 312,
    VPP_DATA_POS_COLORCUSTOMIZE_3DLUT_START = 313,
    VPP_DATA_POS_PQ_MODE_START = 314,
    VPP_DATA_POS_WB_GAMMA_PARAM_START = 315,
    VPP_DATA_POS_COLOR_TUNE_START = 316,
    VPP_DATA_POS_LAST_PQ_MODE_START = 317,
    VPP_DATA_POS_WB_GAMMA_MODE_START = 318,
    VPP_DATA_POS_FMM_MODE_START = 319,
};
#endif
